...
class ProductController extends Controller
{
    ...
    {
        $filters = $request->only(['ids', 'name', 'min_price', 'max_price', 'brand_id', 'category_ids', 'categories', 'taxonomy_ids', 'is_active', 'per_page', 'brand', 'brand_ids', 'order_by', 'order', 'with', 'with_inactive']);
